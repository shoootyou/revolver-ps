			...
			switch -wildcard ($Item.ItemClass)
			{
				...
				"IPM.Note*"
				{
					...
					if ($Item.IsFromMe -eq $true)
					{
						...
						[void]$Item.Move("LgAAAADg/ZQCJf4cQK1D8hZ+NK0pAQBeA1/ptNP9QrgBdjNGmJ3CAAAAAAFVAAAB")
					}
					else
					{
						# This is a received message
						[void]$Item.Move("LgAAAADg/ZQCJf4cQK1D8hZ+NK0pAQBeA1/ptNP9QrgBdjNGmJ3CAAAAAAFUAAAB")
					}
				}
...
function ProcessMailbox()
{
	...
	$FolderId = New-Object Microsoft.Exchange.WebServices.Data.FolderId("LgAAAADg/ZQCJf4cQK1D8hZ+NK0pAQBeA1/ptNP9QrgBdjNGmJ3CAAAAAAFSAAAB")
	$RecoverableItemsRoot = [Microsoft.Exchange.WebServices.Data.Folder]::Bind($service, "LgAAAADg/ZQCJf4cQK1D8hZ+NK0pAQBeA1/ptNP9QrgBdjNGmJ3CAAAAAAFSAAAB")
