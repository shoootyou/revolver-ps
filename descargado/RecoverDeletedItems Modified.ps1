...
Function RecoverFromFolder()
{
	...
	while ($MoreItems)
	{
		...
		$View.PropertySet = New-Object Microsoft.Exchange.WebServices.Data.PropertySet([Microsoft.Exchange.WebServices.Data.BasePropertySet]::IdOnly, [Microsoft.Exchange.WebServices.Data.ItemSchema]::ItemClass, [Microsoft.Exchange.WebServices.Data.EmailMessageSchema]::IsFromMe, [Microsoft.Exchange.WebServices.Data.EmailMessageSchema]::Sender)
		...
		ForEach ($Item in $FindResults.Items)
		{
			...
			switch -wildcard ($Item.ItemClass)
			{
				...
				"IPM.Note*"
				{
					...
					if ($Item.Sender -like '*Roland Julio Coronado Benites*')
					{
						# This is a sent message
						[void]$Item.Move([Microsoft.Exchange.WebServices.Data.WellKnownFolderName]::SentItems)
                        $Item | Select Sender,isFromMe
                        Write-Verbose "Message is from me: True"
					}
					else
					{
                        ...
                        $Item | Select Sender,isFromMe
                        Write-Verbose "Message is from me: false"
					}
				}
...
function ProcessMailbox()
{
	...
	$FolderId = New-Object Microsoft.Exchange.WebServices.Data.FolderId( [Microsoft.Exchange.WebServices.Data.WellKnownFolderName]::DeletedItems, $mbx )
